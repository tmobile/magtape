package kubernetes.admission.test_policy_resource_requests

import data.kubernetes.admission.policy_resource_requests
...
test_resource_requests_allowed {
    ...
    count(policy_resource_requests.deny) == 0 with input as in
...
test_requests_denied_cpu {
    ...
    policy_resource_requests.deny[_] == {
            "errcode": "MT1004",
